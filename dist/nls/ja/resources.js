define({
    ...
    "showAll": "すべて表示",
    "expandInteractiveLegend": "対話形式の凡例の切り替え",
    "zoomTo": "ズーム",
    "totalFeatureCount": "フィーチャ総数",
    "relationshipInstruction": "色の四角形をクリックしてマップをフィルター処理",
    "relationshipLegendElement": "リレーションシップ凡例エレメント",
    "introductionPanelTooltip": "概要パネルを開く",
    "layerListLabel": "レイヤー リストの切り替え",
    "searchLabel": "検索の切り替え",
    "bookmarksLabel": "ブックマークの切り替え",
    "timeFilterLabel": "時間フィルターの切り替え",
    "webAnalytics": {
        "optIn": "オプト イン"
    }
});
