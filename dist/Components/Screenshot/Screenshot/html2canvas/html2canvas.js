        ...
        return t.m = A, t.c = e, t.d = function (A, e, r) {
            ...
            var B = /^#([a-f0-9]{3})$/i, a = function (A) {
                ...
                function A(e) {
                    ...
                    var t = Array.isArray(e) ? Q(e) : a(e) || c(e) || u(e) || w(e) || o(e) || [0, 0, 0, null], n = r(t, 4), B = n[0], s = n[1], i = n[2], l = n[3];
            ...
            var c = e.BACKGROUND_REPEAT = {
                ...
                return t.map(function (A, e) {
                    var t = (B[e] || "auto").trim().split(" ").map(F), a = (r[e] || "auto").trim().split(" ").map(f);
                    return {
                        source: A,
                        repeat: function (A) {
                            switch (A.trim()) {
            ...
            }(t(0)), B = t(3), a = t(4), s = t(12), o = t(33), i = t(34), c = t(35), l = t(36), u = t(37), Q = t(38), w = t(8), U = t(39), g = t(40), C = t(18), d = t(17), F = t(19), f = t(11), E = t(41), h = t(20), H = t(42), p = t(43), N = t(44), I = t(45), K = t(2), T = t(21), m = t(14);
            var v = ["INPUT", "TEXTAREA", "SELECT"], y = function () {
                function A(e, t, r, B) {
                    var y = this;
                    !function (A, e) {
                        if (!(A instanceof e))
                    ...
                    var S = e.ownerDocument.defaultView, L = S.pageXOffset, _ = S.pageYOffset, D = S.getComputedStyle(e, null), M = (0, i.parseDisplay)(D.display), O = "radio" === e.type || "checkbox" === e.type, R = (0, F.parsePosition)(D.position);
                    if (this.style = {
            ...
            var r = t(4), n = e.LIST_STYLE_POSITION = {
                INSIDE: 0,
                OUTSIDE: 1
            }, B = e.LIST_STYLE_TYPE = {
                NONE: -1,
            ...
            e.parseBorder = function (A) {
                return a.map(function (e) {
                    var t = new r.default(A.getPropertyValue("border-" + e + "-color")), B = function (A) {
                        switch (A) {
                            case "none":
                                return n.NONE;
                        }
                        return n.SOLID;
                    }(A.getPropertyValue("border-" + e + "-style")), a = parseFloat(A.getPropertyValue("border-" + e + "-width"));
                    return {
                        borderColor: t,
                        borderStyle: B,
            ...
            var r = t(3), n = o(t(6)), B = o(t(9)), a = t(8), s = t(24);
            function o(A) {
                return A && A.__esModule ? A : {
                    default: A
                };
                        ...
                        value: function (A, e) {
                            ...
                            if (B)
                                if (a(e, B), this.ctx.fillStyle = B, e.radius.x !== e.radius.y) {
                                    var s = A.left + .5 * A.width, o = A.top + .5 * A.height, i = e.radius.y / e.radius.x, c = 1 / i;
            ...
            var r = l(t(9)), n = t(4), B = t(12), a = l(t(50)), s = l(t(7)), o = l(t(0)), i = l(t(1)), c = (t(2), t(22), t(3));
            function l(A) {
                return A && A.__esModule ? A : {
                    default: A
                };
            ...
            var u = new o.default([165, 165, 165]), Q = new o.default([222, 222, 222]), w = {
                borderWidth: 1,
                borderColor: u,
            ...
            }, new i.default("50%")), g = [U, U], C = [g, g, g, g], d = new i.default("3px"), F = [d, d], f = [F, F, F, F], E = (e.getInputBorderRadius = function (A) {
                ...
                for (var r = 0 !== e.style.letterSpacing ? (0, a.toCodePoints)(A).map(function (A) {
                    ...
                    if (e.style.textDecoration !== n.TEXT_DECORATION.NONE || C.trim().length > 0)
                        if (B.default.SUPPORT_RANGE_BOUNDS)
                            w.push(new s(C, i(t, U, C.length, u, Q)));
                        else {
                            var d = t.splitText(C.length);
                            w.push(new s(C, o(t, u, Q))), t = d;
                        }
                    else
                        B.default.SUPPORT_RANGE_BOUNDS || (t = t.splitText(C.length));
                    U += C.length;
                }
                return w;
            }, function (A, e, t) {
            ...
            e.breakWords = function (A, e) {
                ...
                }), B = [], a = void 0; !(a = t.next()).done;)
                    B.push(a.value.slice());
                return B;
            };
        }, function (A, e, t) {
            "use strict";
            ...
            e.Proxy = function (A, e) {
                ...
                return new Promise(function (n, B) {
                    var a = r.default.SUPPORT_CORS_XHR && r.default.SUPPORT_RESPONSE_TYPE ? "blob" : "text", s = r.default.SUPPORT_CORS_XHR ? new XMLHttpRequest : new XDomainRequest;
                ...
                return (t.foreignObjectRendering ? s.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function (s) {
                    return s ? function (A) {
                        return A.inlineFonts(w).then(function () {
                            ...
                            var r = new a.default(A.documentElement), n = w.defaultView, B = n.pageXOffset, s = n.pageYOffset, i = "HTML" === e.tagName || "BODY" === e.tagName ? (0, o.parseDocumentSize)(w) : (0, o.parseBounds)(e, B, s), c = i.width, l = i.height, u = i.left, U = i.top;
                            return r.render({
                                backgroundColor: d,
                                logger: Q,
                                scale: t.scale,
                        ...
                        return d === u.container.style.background.backgroundColor && (u.container.style.background.backgroundColor = l.TRANSPARENT), i.ready().then(function (A) {
                            ...
                            var r = U.defaultView, n = r.pageXOffset, i = r.pageYOffset, l = "HTML" === s.tagName || "BODY" === s.tagName ? (0, o.parseDocumentSize)(w) : (0, o.parseBounds)(s, n, i), g = l.width, C = l.height, F = l.left, f = l.top, E = {
                                backgroundColor: d,
                                fontMetrics: e,
                                imageStore: A,
                                logger: Q,
            ...
            var r = i(t(30)), n = i(t(6)), B = i(t(9)), a = t(21), s = t(14), o = t(8);
            function i(A) {
                return A && A.__esModule ? A : {
                    default: A
                };
                    ...
                    if (g instanceof C.Text || g instanceof Text || C.parent && g instanceof C.parent.Text)
                        ...
                        if (-1 === c.indexOf(g.nodeName)) {
                            ...
                            if (d.isVisible()) {
                                ...
                                var F = "TEXTAREA" !== g.tagName, f = u(d, g);
                                if (f || Q(d)) {
                                    var E = f || d.isPositioned() ? i.getRealParentStackingContext() : i, h = new r.default(d, E, f);
            ...
            var a = function (A, e, t) {
                ...
                return r(A, [{
                        key: "subdivide",
                        value: function (e, t) {
                            var r = a(this.start, this.startControl, e), n = a(this.startControl, this.endControl, e), B = a(this.endControl, this.end, e), s = a(r, n, e), o = a(n, B, e), i = a(s, o, e);
            ...
            e.parseBorderRadius = function (A) {
                return B.map(function (e) {
                    var t = A.getPropertyValue("border-" + e + "-radius").split(" ").map(n.default.create), B = r(t, 2), a = B[0], s = B[1];
            ...
            }, B = /(matrix|matrix3d)\((.+)\)/, a = (e.parseTransform = function (A) {
            ...
            var o = e.LETTER_NUMBER_MODIFIER = 50, i = 10, c = 13, l = 15, u = 17, Q = 18, w = 19, U = 20, g = 21, C = 22, d = 24, F = 25, f = 26, E = 27, h = 28, H = 30, p = 32, N = 33, I = 34, K = 35, T = 37, m = 38, v = 39, y = 40, b = 42, S = (e.classes = {
                BK: 1,
                CR: 2,
                LF: 3,
                CM: 4,
                ...
                SA: b,
                XX: 43
            }, e.BREAK_MANDATORY = "!"), L = e.BREAK_NOT_ALLOWED = "×", _ = e.BREAK_ALLOWED = "÷", D = e.UnicodeTrie = (0, B.createTrieFromBase64)(a.default), M = [H, 36], O = [1, 2, 3, 5], R = [i, 8], P = [E, f], X = O.concat(R), z = [m, v, y, I, K], x = [l, c], V = e.codePointsToCharacterClasses = function (A) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "strict", t = [], r = [], n = [];
                return A.forEach(function (A, B) {
                    var a = D.get(A);
                    if (a > o ? (n.push(!0), a -= o) : n.push(!1), -1 !== ["normal", "auto", "loose"].indexOf(e) && -1 !== [8208, 8211, 12316, 12448].indexOf(A))
                        return r.push(B), t.push(16);
                    if (4 === a || 11 === a) {
                        if (0 === B)
                            return r.push(B), t.push(H);
                        var s = t[B - 1];
                ...
                if (Array.isArray(n) && !0 === n[B])
                    return L;
                var a = B - 1, s = B + 1, o = e[B], H = a >= 0 ? e[a] : 0, b = e[s];
                if (2 === o && 3 === b)
                    return L;
                if (-1 !== O.indexOf(o))
                    return S;
                ...
                if (8 === J(B, e))
                    return _;
                if (11 === D.get(A[B]) && (b === T || b === p || b === N))
                    return L;
                if (7 === o || 7 === b)
                    return L;
                if (9 === o)
                    return L;
                if (-1 === [i, c, l].indexOf(o) && 9 === b)
                    return L;
                if (-1 !== [u, Q, w, d, h].indexOf(b))
                    return L;
                if (J(B, e) === C)
                    return L;
                if (k(23, C, B, e))
                ...
                if (16 === b || 16 === o)
                    return _;
                if (-1 !== [c, l, g].indexOf(b) || 14 === o)
                    return L;
                if (36 === H && -1 !== x.indexOf(o))
                    return L;
                if (o === h && 36 === b)
                    return L;
                if (b === U && -1 !== M.concat(U, w, F, T, p, N).indexOf(o))
                    return L;
                if (-1 !== M.indexOf(b) && o === F || -1 !== M.indexOf(o) && b === F)
                    return L;
                if (o === E && -1 !== [T, p, N].indexOf(b) || -1 !== [T, p, N].indexOf(o) && b === f)
                    return L;
                if (-1 !== M.indexOf(o) && -1 !== P.indexOf(b) || -1 !== P.indexOf(o) && -1 !== M.indexOf(b))
                    return L;
                if (-1 !== [E, f].indexOf(o) && (b === F || -1 !== [C, l].indexOf(b) && e[s + 1] === F) || -1 !== [C, l].indexOf(o) && b === F || o === F && -1 !== [F, h, d].indexOf(b))
                    return L;
                ...
                if (m === o && -1 !== [m, v, I, K].indexOf(b) || -1 !== [v, I].indexOf(o) && -1 !== [v, y].indexOf(b) || -1 !== [y, K].indexOf(o) && b === y)
                    return L;
                if (-1 !== z.indexOf(o) && -1 !== [U, f].indexOf(b) || -1 !== z.indexOf(b) && o === E)
                    return L;
                if (-1 !== M.indexOf(o) && -1 !== M.indexOf(b))
                    return L;
                if (o === d && -1 !== M.indexOf(b))
                    return L;
                if (-1 !== M.concat(F).indexOf(o) && b === C || -1 !== M.concat(F).indexOf(b) && o === Q)
                    return L;
                if (41 === o && 41 === b) {
                ...
                var t = V(A, e.lineBreak), r = n(t, 3), B = r[0], a = r[1], s = r[2];
                ...
                var t = (0, s.toCodePoints)(A), r = L, B = Y(t, e), a = n(B, 3), o = a[0], i = a[1], c = a[2];
            ...
            e.LineBreaker = function (A, e) {
                var t = (0, s.toCodePoints)(A), r = Y(t, e), B = n(r, 3), a = B[0], o = B[1], i = B[2], c = t.length, l = 0, u = 0;
                return {
                    next: function () {
                        if (u >= c)
                            return {
            ...
            var B = e.UTRIE2_SHIFT_2 = 5, a = e.UTRIE2_SHIFT_1 = 11, s = e.UTRIE2_INDEX_SHIFT = 2, o = e.UTRIE2_SHIFT_1_2 = a - B, i = e.UTRIE2_LSCP_INDEX_2_OFFSET = 65536 >> B, c = e.UTRIE2_DATA_BLOCK_LENGTH = 1 << B, l = e.UTRIE2_DATA_MASK = c - 1, u = e.UTRIE2_LSCP_INDEX_2_LENGTH = 1024 >> B, Q = e.UTRIE2_INDEX_2_BMP_LENGTH = i + u, w = e.UTRIE2_UTF8_2B_INDEX_2_OFFSET = Q, U = e.UTRIE2_UTF8_2B_INDEX_2_LENGTH = 32, g = e.UTRIE2_INDEX_1_OFFSET = w + U, C = e.UTRIE2_OMITTED_BMP_INDEX_1_LENGTH = 65536 >> a, d = e.UTRIE2_INDEX_2_BLOCK_LENGTH = 1 << o, F = e.UTRIE2_INDEX_2_MASK = d - 1, f = (e.createTrieFromBase64 = function (A) {
            ...
            }(), B = t(2), a = (t(25), t(52)), s = function (A) {
                return A && A.__esModule ? A : {
                    default: A
                };
            }(t(9)), o = t(4), i = t(12);
            var c = function () {
                ...
                return n(A, [{
                        ...
                        value: function (A) {
                            var e = this, t = function () {
                                if (A.childNodes.length && A.childNodes.forEach(function (t) {
                                    ...
                                    if (t) {
                                        var r = (0, B.calculateContentBox)(A.bounds, A.style.padding, A.style.border), n = "number" == typeof t.width && t.width > 0 ? t.width : r.width, a = "number" == typeof t.height && t.height > 0 ? t.height : r.height;
                        ...
                        value: function (A, e) {
                            ...
                            if (t) {
                                var r = (0, o.calculateBackgroungPositioningArea)(A.style.background.backgroundOrigin, A.bounds, A.style.padding, A.style.border), n = (0, o.calculateBackgroundSize)(e, t, r), B = (0, o.calculateBackgroundPosition)(e.position, n, r), a = (0, o.calculateBackgroundRepeatPath)(e, B, n, r, A.bounds), s = Math.round(r.left + B.x), i = Math.round(r.top + B.y);
                        ...
                        value: function (A, e) {
                            var t = (0, o.calculateBackgroungPositioningArea)(A.style.background.backgroundOrigin, A.bounds, A.style.padding, A.style.border), r = (0, o.calculateGradientBackgroundSize)(e, t), n = (0, o.calculateBackgroundPosition)(e.position, r, t), s = new B.Bounds(Math.round(t.left + n.x), Math.round(t.top + n.y), r.width, r.height), i = (0, a.parseGradient)(A, e.source, s);
                            if (i)
                                switch (i.type) {
                        ...
                        value: function (A) {
                            var e = u(A), t = r(e, 5), n = t[0], B = t[1], a = t[2], s = t[3], o = t[4], i = l(A), c = r(i, 2), w = c[0], U = c[1];
            ...
            }(), n = (i(t(6)), t(53)), B = i(t(0)), a = t(1), s = i(a), o = t(3);
            function i(A) {
                return A && A.__esModule ? A : {
                    default: A
                };
            ...
            var l = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i, u = /^([+-]?\d*\.?\d+)% ([+-]?\d*\.?\d+)%$/i, Q = /(px)|%|( 0)$/i, w = /^(from|to|color-stop)\((?:([\d.]+)(%)?,\s*)?(.+?)\)$/i, U = /^\s*(circle|ellipse)?\s*((?:([\d.]+)(px|r?em|%)\s*(?:([\d.]+)(px|r?em|%))?)|closest-side|closest-corner|farthest-side|farthest-corner)?\s*(?:at\s*(?:(left|center|right)|([\d.]+)(px|r?em|%))\s+(?:(top|center|bottom)|([\d.]+)(px|r?em|%)))?(?:\s|$)/i, g = e.GRADIENT_TYPE = {
                ...
                var r = (0, n.parseAngle)(A[0]), B = l.test(A[0]), a = B || null !== r || u.test(A[0]), s = a ? null !== r ? p(t ? r - .5 * Math.PI : r, e) : B ? I(A[0], e) : K(A[0], e) : p(Math.PI, e), i = a ? 1 : 0, c = Math.min((0, o.distance)(Math.abs(s.x0) + Math.abs(s.x1), Math.abs(s.y0) + Math.abs(s.y1)), 2 * e.width, 2 * e.height);
                ...
                var t = e.width, r = e.height, n = .5 * t, B = .5 * r, a = (Math.abs(t * Math.sin(A)) + Math.abs(r * Math.cos(A))) / 2, s = n + Math.sin(A) * a, o = B - Math.cos(A) * a;
                return {
                    x0: s,
                    x1: t - s,
                    y0: o,
            ...
            }(), B = t(2), a = t(26), s = u(t(55)), o = t(3), i = t(4), c = u(t(15)), l = t(56);
            function u(A) {
                return A && A.__esModule ? A : {
                    default: A
                };
            ...
            var Q = e.DocumentCloner = function () {
                ...
                return n(A, [{
                        ...
                        value: function (A) {
                            ...
                            if ((0, l.popCounters)(a, this.pseudoContentData), A instanceof t.HTMLElement && e instanceof t.HTMLElement)
                                switch (n && this.inlineAllImages(C(A, e, n, s, d)), B && this.inlineAllImages(C(A, e, B, c, F)), !r || !this.copyStyles || A instanceof HTMLIFrameElement || (0, o.copyCSSStyles)(r, e), this.inlineAllImages(e), 0 === A.scrollTop && 0 === A.scrollLeft || this.scrolledElements.push([e, A.scrollLeft, A.scrollTop]), A.nodeName) {
                                    case "CANVAS":
            ...
            }, d = ":before", F = ":after", f = "___html2canvas___pseudoelement_before", E = "___html2canvas___pseudoelement_after", h = function (A) {
                ...
                return T(A, e).then(function (n) {
                    var B = n.contentWindow, i = B.document, c = m(n).then(function () {
                        ...
                        var t = Promise.resolve([n, a.clonedReferenceElement, a.resourceLoader]), s = r.onclone;
                ...
                return r(A, [{
                        ...
                        value: function (A) {
                            ...
                            if (this.hasResourceInCache(A))
                                return A;
                            if (w(A))
                                return this.cache[A] = g(A, this.options.imageTimeout || 0), A;
                            if (!U(A) || n.default.SUPPORT_SVG_DRAWING) {
                                if (!0 === this.options.allowTaint || u(A) || this.isSameOrigin(A))
                                    return this.addImage(A, A, !1);
                                if (!this.isSameOrigin(A)) {
                                    if ("string" == typeof this.options.proxy)
                                        return this.cache[A] = (0, B.Proxy)(A, this.options).then(function (A) {
                                            return g(A, e.options.imageTimeout || 0);
                                        }), A;
                                    if (!0 === this.options.useCORS && n.default.SUPPORT_CORS_IMAGES)
            ...
            }(), i = /^data:image\/svg\+xml/i, c = /^data:image\/.*;base64,/i, l = /^data:image\/.*/i, u = function (A) {
                return l.test(A);
            }, Q = function (A) {
                return c.test(A);
            }, w = function (A) {
