define(["require", "exports", "tslib", "dojo/i18n!./Screenshot/nls/resources", "esri/widgets/Widget", "esri/core/accessorSupport/decorators", "esri/core/watchUtils", "esri/core/Handles", "esri/widgets/support/widget", "./Screenshot/ScreenshotViewModel", "esri/widgets/Feature"], function (require, exports, tslib_1, resources_1, Widget, decorators_1, watchUtils, Handles, widget_1, ScreenshotViewModel, FeatureWidget) {
    ...
    var Screenshot = /** @class */ (function (_super) {
        ...
        function Screenshot(value) {
            ...
            _this.includeLayoutOption = null;
        ...
        Screenshot.prototype._renderScreenshotLayout = function () {
            ...
            return (widget_1.tsx("label", { class: CSS.selectLayout },
                widget_1.tsx("span", null, resources_1.default.screenshotLayout),
                widget_1.tsx("select", { bind: this, onchange: this._updateLayoutOption, disabled: allDisabled },
                    widget_1.tsx("option", { value: "horizontal", selected: this.outputLayout === "horizontal" ? true : false }, resources_1.default.horizontal),
                    widget_1.tsx("option", { value: "vertical", selected: this.outputLayout === "vertical" ? true : false }, resources_1.default.vertical))));
        };
        ...
        Screenshot.prototype._renderScreenshotPreviewOverlay = function () {
            ...
            return (widget_1.tsx("div", { class: this.classes(CSS.screenshotDiv, overlayIsVisible) },
                widget_1.tsx("div", { bind: this, "data-node-ref": "previewContainer", class: CSS.screenshotPreviewContainer, role: "dialog", "aria-label": resources_1.default.downloadImage, afterCreate: widget_1.storeNode },
                    ...
                    widget_1.tsx("input", { bind: this, type: "text", afterCreate: widget_1.storeNode, "data-node-ref": "previewTitleInputNode", placeholder: resources_1.default.enterTitle }),
        ...
        Screenshot.prototype._renderOptOutOfScreenshotButton = function () {
            return (widget_1.tsx("calcite-button", { bind: this, tabIndex: 0, class: this.classes(CSS.pointerCursor, CSS.screenshotClose), onclick: this.deactivateScreenshot, onkeydown: this.deactivateScreenshot, title: resources_1.default.deactivateScreenshot, color: "red" },
