            ...
            if (isDiamond) {
                return (widget_1.tsx("div", { key: this.layerView.layer.id + "-relationship" },
                    ...
                    widget_1.tsx("div", { key: "" + this.id, class: CSS.diamondContainer },
                        dir === "rtl" ? (widget_1.tsx("div", { class: CSS.diamondLeftCol }, labels.left)) : (widget_1.tsx("div", { class: CSS.diamondRightCol }, labels.right)),
                        ...
                        dir === "rtl" ? (widget_1.tsx("div", { class: CSS.diamondRightCol }, labels.right)) : (widget_1.tsx("div", { class: CSS.diamondLeftCol }, labels.left)))));
            }
