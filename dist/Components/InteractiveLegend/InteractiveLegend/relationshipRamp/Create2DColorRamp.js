    ...
    var Create2DColorRamp = /** @class */ (function (_super) {
                    ...
                    if (_this.featureCountEnabled) {
                        var queryFeatureCount_1 = promiseUtils.debounce(function () {
                            ...
                            var queryFeatureCount = _this.layerView &&
                                ...
                                _this.layerView.queryFeatureCount({
                                    ...
                                    where: where,
                                    timeExtent: ((_b = (_a = _this.layerView) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b.timeExtent) ? _this.layerView.filter.timeExtent
                                        : ((_e = (_d = (_c = _this.layerView) === null || _c === void 0 ? void 0 : _c.effect) === null || _d === void 0 ? void 0 : _d.filter) === null || _e === void 0 ? void 0 : _e.timeExtent) ? _this.layerView.effect.filter.timeExtent
                                            : null
                                });
                        ...
                        if (!_this._handles.has(featureCountKey)) {
                            _this._handles.add([
                                ...
                                watchUtils.watch(_this.layerView, "filter.timeExtent, effect.filter.timeExtent", function () {
                                    queryFeatureCount_1();
                                })
                            ], featureCountKey);
                        }
                    ...
                    if (_this.filterMode === "featureFilter") {
                        ...
                        _this._handles.add(watchUtils.when(_this, "layerView.filter", function () {
                            ...
                            _this._handles.add(watchUtils.watch(_this, "layerView.filter.where", function () {
                                ...
                                var cellGroup = _this.colorRampProperties.surface.children[0]
                                    .children;
                                if (!((_b = (_a = _this.layerView) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b.where)) {
                        ...
                        _this._handles.add(watchUtils.when(_this, "layerView.effect", function () {
                            ...
                            _this._handles.add(watchUtils.watch(_this, "layerView.effect.filter.where", function () {
                                ...
                                var cellGroup = _this.colorRampProperties.surface.children[0]
                                    .children;
                                if (!((_c = (_b = (_a = _this.layerView) === null || _a === void 0 ? void 0 : _a.effect) === null || _b === void 0 ? void 0 : _b.filter) === null || _c === void 0 ? void 0 : _c.where)) {
                                    cellGroup.forEach(function (cell) {
        ...
        Create2DColorRamp.prototype._generateTotalFeatureCount = function () {
            ...
            this.layerView
                .queryFeatureCount({
                where: where,
                timeExtent: ((_b = (_a = this.layerView) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b.timeExtent) ? this.layerView.filter.timeExtent
                    : ((_e = (_d = (_c = this.layerView) === null || _c === void 0 ? void 0 : _c.effect) === null || _d === void 0 ? void 0 : _d.filter) === null || _e === void 0 ? void 0 : _e.timeExtent) ? this.layerView.effect.filter.timeExtent
                        : null
            })
                ...
                if (this.filterMode === "mute") {
                    ...
                    this.layerView.effect = new FeatureEffect({
                        filter: new FeatureFilter({
                            where: where,
                            timeExtent: ((_c = (_b = (_a = this.layerView) === null || _a === void 0 ? void 0 : _a.effect) === null || _b === void 0 ? void 0 : _b.filter) === null || _c === void 0 ? void 0 : _c.timeExtent) ? this.layerView.effect.filter.timeExtent
                                : null
                        }),
                    ...
                    this.layerView.filter = new FeatureFilter({
                        where: where,
                        timeExtent: ((_e = (_d = this.layerView) === null || _d === void 0 ? void 0 : _d.filter) === null || _e === void 0 ? void 0 : _e.timeExtent) ? this.layerView.filter.timeExtent
                            : null
                    });
                }
